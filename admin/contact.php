        ...
        <!-- End of Topbar -->
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Contact Page
                    <form action="code.php" method="POST">
                        <button type="submit" name="contact_delete_multiple_data" class="btn btn-danger">Delete Multiple Data</button>
                    </form>                    
                    </h6>
                </div>
