        ...
        <!-- End of Topbar -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add Blog-Single</h5>
                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="blog_single_save" class="btn btn-primary">Save</button>
                                </div>
                            </div>
                        </form> 
                    </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Blog-Single Page
                    <form action="code.php" method="POST">
                        <button type="submit" name="portfolio_delete_multiple_data" class="btn btn-danger">Delete Multiple Data</button>
                    </form>
                ...
                ?>
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><?php echo '<img src="upload/blog_single/'.$row['image'].'" width="100px;" height="100px;" alt="Image">' ?></td>
                            <td>
                                <form action="blog_single_edit.php" method="POST">
                            ...
                            <td>
                                <form action="code.php" method="POST">
                                    ...
                                    <button type="submit" name="blog_single_delete_btn" class="btn btn-danger">DELETE</button>
                                </form>
                            </td>
                        </tr>
                        <?php                                                
