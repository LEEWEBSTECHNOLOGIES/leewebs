        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <img src="img/favicon.png" alt="logo" style="width: 40px; height: 30px;">
                    <!-- <i class="fas fa-laugh-wink"></i> -->
                </div>
                
                <div class="sidebar-brand-text mx-3">LEEWEBS TECHNOLOGIES</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="testimony.php">Testimony</a>
                        <a class="collapse-item" href="blog.php">Blog</a>
                        <a class="collapse-item" href="blog-single.php">Single-Blog</a>
