        ...
        <!-- End of Topbar -->
                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="date" name="date" class="form-control" placeholder="Enter Description" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="portfolio_save" class="btn btn-primary">Save</button>
                                </div>
                            </div>
                        </form> 
                    </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Portfolio Page
                ...
                ?>
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><?php echo '<img src="upload/portfolio/'.$row['image'].'" width="100px;" height="100px;" alt="Image">' ?></td>
                            <td>
                            ...
                            <td>
                                <form action="code.php" method="POST">
                                    ...
                                    <button type="submit" name="portfolio_delete_btn" class="btn btn-danger">DELETE</button>
                                </form>
                            </td>
                        </tr>
                        <?php                                                
